...
define("PAJAK", 0.1); // Definisi konstanta pajak
...
$total_harga = $harga_satuan * $jumlah_beli; // Menghitung total harga sebelum pajak

$nilai_pajak = $total_harga * PAJAK; // Menghitung nilai pajak

$total_bayar = $total_harga + $nilai_pajak; // Menghitung total bayar
?>
